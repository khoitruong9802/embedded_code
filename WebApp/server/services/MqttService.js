...
const handleMessageSensor = (topic, message) => {
  ...
  let fieldToUpdate;
  switch (topic) {
    case "dongnguyen1543/feeds/get-temp":
      fieldToUpdate = "temperature";
      break;
    case "dongnguyen1543/feeds/get-light":
      fieldToUpdate = "light";
      break;
    case "dongnguyen1543/feeds/get-humi":
...
const handleMessageDevice = (topic, message) => {
  ...
  let fieldToUpdate;
  switch (topic) {
    case "dongnguyen1543/feeds/control-door":
      fieldToUpdate = "door";
      break;
    case "dongnguyen1543/feeds/control-fan":
      fieldToUpdate = "fan";
      break;
    case "dongnguyen1543/feeds/control-lamp":
      fieldToUpdate = "lamp";
      break;
    default:
      console.log("Unknown topic:", topic);
